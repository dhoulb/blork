...
export const checkers: { [key: string]: CheckerFunction } = {
	...
	'object': (v: any) => (typeof v === 'object' && v !== null && v.constructor === Object) || 'Must be an object',
	'object+': (v: any) => (typeof v === 'object' && v !== null && v.constructor === Object && Object.keys(v).length > 0) || 'Must be an object with one or more enumerable properties',
	...
	'array': (v: any) => (v instanceof Array && v.constructor === Array) || 'Must be an array',
	'array+': (v: any) => (v instanceof Array && v.constructor === Array && v.length > 0) || 'Must be a non-empty array',
