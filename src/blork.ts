...
export default function blork() {
	 ...
	 * @throws An error describing what went wrong (usually an error object).
	 */
	function args(argsObj: ArgumentsObject, types: TypesArray) {
	 ...
	 */
	function add(name: string, checker: CheckerFunction) {
	 ...
	 */
	function throws(err: ErrorConstructor) {
