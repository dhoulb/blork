...
exports.checkers = {
    ...
    'object': (v) => (typeof v === 'object' && v !== null && v.constructor === Object) || 'Must be an object',
    'object+': (v) => (typeof v === 'object' && v !== null && v.constructor === Object && Object.keys(v).length > 0) || 'Must be an object with one or more enumerable properties',
    'iterable': (v) => (typeof v === 'object' && v !== null && typeof v[Symbol.iterator] === 'function') || 'Must be an iterable object',
    'array': (v) => (v instanceof Array && v.constructor === Array) || 'Must be an array',
    'array+': (v) => (v instanceof Array && v.constructor === Array && v.length > 0) || 'Must be a non-empty array',
