...
function blork$add(name, checker, description) {
	...
	if (typeof checker !== "string" && typeof checker !== "function") throw new BlorkError("add(): checker: Must be string or function", checker);
	if (description && typeof description !== "string") throw new BlorkError("add(): description: Must be non-empty string", description);
