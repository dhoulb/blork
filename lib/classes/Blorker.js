...
class Blorker {
	 ...
	 * @param {string} description="" A description of the type of value that's valid for this assertion, e.g. "positive number" or "unique string" or "instance of Dog".
	...
	assert(assertion, description, prefix, error) {
		...
		// Enforce assertion.
		if (!assertion) throwError(error || this._error, `Must be ${description}`, undefined, prefix || "");
	}
